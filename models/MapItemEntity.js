...
class MapItemEntity extends Model {
    ...
    suggestedVal() {
        ...
        for (let i = 0; typeof allAvailableItems[i] !== 'undefined'; i++) {
            let availableItem = allAvailableItems[i];
    ...
    isValid() {
        ...
        for (let i = 0; typeof allAvailableItems[i] !== 'undefined'; i++) {
            ...
            for (let j = 0; typeof this.validation_keys[j] !== 'undefined'; j++) {
                let validation_keysItem = this.validation_keys[j];
                if (this[validation_keysItem] && availableItem[validation_keysItem] && this[validation_keysItem] === availableItem[validation_keysItem]) {
                    return true;
                }
            }
        }
