                ...
                <v-col>
                    ...
                    <div class="d-flex subtitle">
                        <div class="d-flex part align-start">
                            <v-img
                                src="http://nodes.alaatv.com/upload/abrisham-panel-ic_alaa.png"
...
export default {
    ...
    data(){
        return{
            ...
            poster: '',
            markedRatios: [
                // { ratio: 25, hasSeen: false },
                // { ratio: 50, hasSeen: false },
                // { ratio: 75, hasSeen: false },
        ...
        setContentSources(data) {
            ...
            for (var i in someData) {
                ...
                sources.list.push({
                    ...
                    'type': 'video/mp4',
                    'label': item.res,
                    'selected': item.res === '480p'
                })
            }
            this.sources = sources.list
        },
        setContentTimePoint(data) {
            var someData = data
            var timePoint = {
                list: []
            }
            ...
            this.timePoints = timePoint.list
        },
